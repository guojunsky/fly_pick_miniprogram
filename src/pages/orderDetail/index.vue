			...
			<view class="address">
				...
				<view class="send_line">
					...
					<view class="send_right">
						...
						<view class="address_txt">{{detail.chinaAddress.province}}{{detail.chinaAddress.city}}{{detail.chinaAddress.town}}{{detail.chinaAddress.ext}}</view>
					</view>
				</view>
				<view class="send_line">
					<view class="icon_box">
					...
					<view class="send_right">
						...
						<view class="address_txt">{{detail.abroadAddress.country}}{{detail.abroadAddress.city}}{{detail.abroadAddress.addr}}{{detail.abroadAddress.companyName}}{{detail.abroadAddress.ext}}</view>
					</view>
				</view>
			</view>
			<!-- 物品类型 -->
			...
			<view class="btn_box" v-if="detail.orderStatus == 300 || detail.canPay">
				<view class="b_left">
					...
					<view class="order_detail" @click="handlerShowDetail">
						...
						<image :class="['arrow_img',totalPriceVisible ? 'up_arrow' : '']" src="../../static/detail/dwon_arrow.png"></image>
					</view>
				</view>
